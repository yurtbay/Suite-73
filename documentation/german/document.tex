...
\newcommand{\projektName}{Suite 73 - All-In-One Data Management}
...
\begin{document}
	...
	\section{Lastenheft}
		...
		\subsection{Einleitung} %A
 		\input{lastenheft/einleitung}
 		
		\subsection{Ist-Zustand} %C
 		\input{lastenheft/istZustand}
 		
		\subsection{Soll-Konzept} %E
 		\input{lastenheft/sollKonzept}
 		
		\subsection{Schnittstellen}
 		\input{lastenheft/schnittstellen}
 		
		\subsection{Funktionale Anforderungen}
 		\input{lastenheft/funktionaleAnforderungen}
 		
		\subsection{Nichtfunktionale Anforderungen}
            \subsubsection{Benutzbarkeit}
            \input{lastenheft/benutzbarkeit}
            
            \subsubsection{Zuverlässigkeit}
            \input{lastenheft/zuverlaessigkeit}
            
            \subsubsection{Effizienz}
            \input{lastenheft/effizienz}
            
            \subsubsection{Änderbarkeit}
            \input{lastenheft/aenderbarkeit}
            
            \subsubsection{Übertragbarkeit}
            \input{lastenheft/uebertragbarkeit}
            
            \subsubsection{Wartbarkeit}
            \input{lastenheft/wartbarkeit}
        
        \subsection{Risikoakzeptanz}
 		\input{lastenheft/risikoakzeptanz}
        
        \subsection{Risikoakzeptanz}
 		\input{lastenheft/risikoakzeptanz}
        
        \subsection{Entwicklungszyklus}
 		\input{lastenheft/entwicklungszyklus}
        
        \subsection{Systemarchitektur}
 		\input{lastenheft/systemarchitektur}
        
        \subsection{Lieferumfang}
 		\input{lastenheft/lieferumfang}
        
        \subsection{Abnahmekriterien}
 		\input{lastenheft/abnahmekriterien}
 	\clearpage
